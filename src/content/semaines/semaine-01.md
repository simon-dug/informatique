---
numero: 1
theme: "Bienvenue et prise en main des outils"
date: 2026-08-31
etape: 1
resume: "Présentation du cours, connexion aux comptes de l'école, bonne utilisation du Chromebook et premiers défis collaboratifs dans le Drive."
objectifs:
...
2. Aller dans **Google Drive** et créer un dossier pour chaque matière à
   votre horaire.
3. Dans votre dossier **Informatique**, créer un fichier **Google Docs**
   nommé « Test du début d'année ». Dans ce fichier, inscrire la phrase :
   « Je me nomme *(inscrire votre nom)* et je suis dans le groupe
   *(inscrire votre numéro de groupe)*. »
4. Partager le fichier « Test du début d'année » avec toutes les personnes de
   votre équipe, en mode **Éditeur** (droit de modification).
5. Aller dans **Partagés avec moi**, dans le Drive, et ouvrir les fichiers
